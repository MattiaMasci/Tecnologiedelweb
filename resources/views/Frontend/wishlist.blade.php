                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a href="#"><img src="{{ asset('img/Frontend.img/man/polo-shirt-1.png') }}" alt="img"></a></td>
                      ...
                      <tr>
                        <td><a class="remove" href="#"><fa class="fa fa-close"></fa></a></td>
                        <td><a href="#"><img src="{{ asset('img/Frontend.img/man/polo-shirt-2.png') }}" alt="img"></a></td>
                        <td><a class="aa-cart-title" href="#">Polo T-Shirt</a></td>
                        <td>$150</td>
                        <td>In Stock</td>
                        <td><a href="#" class="aa-add-to-cart-btn">Add To Cart</a></td>
                      ...
                      <tr>
                        <td><a class="remove" href="#"><fa class="fa fa-close"></fa></a></td>
                        <td><a href="#"><img src="{{ asset('img/Frontend.img/man/polo-shirt-3.png') }}" alt="img"></a></td>
                        <td><a class="aa-cart-title" href="#">Polo T-Shirt</a></td>
                        <td>$50</td>
                        <td>In Stock</td>
                        <td><a href="#" class="aa-add-to-cart-btn">Add To Cart</a></td>
