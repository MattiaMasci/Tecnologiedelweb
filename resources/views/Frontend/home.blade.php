                              ...
                              <div class="col-md-5 no-padding">
                                  <div class="aa-promo-left">
                                      <div class="aa-promo-banner">
                                          <a href="{{url("brand/$topBrand->sesso&&$topBrand->reference")}}"><img src="../public/store-image/fetch-brand-image/{{ $topBrand->id }}" alt="img"></a>
                                  ...
                                  <div class="aa-promo-right">
                                      @foreach ($brands as $brand)
                                          <div class="aa-single-promo-right">
                                              <div class="aa-promo-banner">
                                                  <a href="{{url("brand/$brand->sesso&&$brand->reference ")}}"><img src="../public/store-image/fetch-brand-image/{{ $brand->id }}" alt="img"></a>
                                                  <!-- <div class="aa-prom-content">
                                                      <span></span>
                                                  </div> -->
                                              </div>
