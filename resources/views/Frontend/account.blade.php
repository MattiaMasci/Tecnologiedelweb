            ...
            <div class="row">
                ...
                <div class="aa-myaccount-register">
                 ...
                 <form method="POST" action="{{ route('register') }}" class="aa-login-form">
                     ...
                     <input type="text" id="name" placeholder="Nome" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>

                     <label for="">{{ __('Cognome') }}<span>*</span></label>
                     <input type="text" id="cognome" placeholder="Cognome" class="form-control @error('cognome') is-invalid @enderror" name="cognome" value="{{ old('cognome') }}" required autocomplete="cognome" autofocus>
