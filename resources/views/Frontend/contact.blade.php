...
@section('content')
  ...
  <section id="aa-catg-head-banner">
   <img src="../public/store-image/fetch-fotosito-image/{{ $contact_foto->id }}" alt="fashion img">
                 ...
                 <div class="aa-contact-address-left">
                   <form class="comments-form contact-form" method="post" action="{{ url("/contact") }}" id="send_message" name="send_message">
                    @csrf
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <input type="email" name="email" value="@if($profilo!=null){{ $profilo->emailfatturazione }}@endif" placeholder="Email" class="form-control" required>
                        </div>
                      </div>
                    </div>
                     <div class="row">
