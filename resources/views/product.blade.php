                ...
                @foreach($photo as $photo)
                  <li>
                    <figure>
                      ...
                      <a class="aa-product-img" href="#"><img src="@php echo $photo; @endphp" alt="polo shirt img"></a>
                      <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Aggiungi al carrello</a>
                      <figcaption>
                        <h4 class="aa-product-title"><a href="#">@php echo $modello[$i]; $i=$i+1; @endphp</a></h4>
      ...
      <div class="modal-content">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          ...
          <form class="aa-login-form" action="">
            <label for="">Username o indirizzo email<span>*</span></label>
            <input type="text" placeholder="Username or email">
            <label for="">Password<span>*</span></label>
            <input type="password" placeholder="Password">
            <button class="aa-browse-btn" type="submit">Login</button>
            <label for="rememberme" class="rememberme"><input type="checkbox" id="rememberme"> Ricordami </label>
            <p class="aa-lost-password"><a href="#">Hai perso la tua password?</a></p>
            <div class="aa-register-now">
              Non hai un account?<a href="account.html">Registrati ora!</a>
            </div>
          </form>
        </div>
      </div><!-- /.modal-content -->
