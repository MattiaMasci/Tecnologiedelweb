            ...
            <ul class="nav navbar-nav">
              <li><a href="#">Uomo <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  ...
                  <li><a href="{{url('product/Maschio&&T-shirt')}}">T-shirt & Polo</a></li>
       ...
       <div class="modal-content">
         <div class="modal-body">
           ...
           <form class="aa-login-form" method="POST" action="{{ route('login') }}">
             ...
             <p class="aa-lost-password"><a href="{{ route('password.request') }}">
                 {{ __('Forgot Your Password?') }}
               </a></p>


             <div class="aa-register-now">
               Don't have an account?<a href="{{ route('register') }}">{{ __('Register now!') }}</a>
             </div>
