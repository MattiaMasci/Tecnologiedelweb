                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url("/admin/edit-product/$productDetails->id") }}" name="edit_product" id="edit_product" novalidate="novalidate">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="brief_description" id="brief_description">{{ $productDetails->descrizione }}</textarea>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Description</label>
                                    <div class="controls">
                                        <textarea name="description" id="description">{{ $productDetails->descrizione1 }}</textarea>
                                    </div>
                                </div>
                                <div class="control-group">
